...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_50_d125_25 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 50 -fclkop 125 -fclkop_tol 0.0 -fclkos 125 -fclkos_tol 0.0 -fclkos2 25 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 180 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock 

-- Tue Oct  4 12:15:11 2016
...
architecture Structure of clk_50_d125_25 is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  5, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  3, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  20, 
        CLKOS_DIV=>  4, CLKOP_DIV=>  4, CLKFB_DIV=>  5, CLKI_DIV=>  2, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of clk_50_d125_25 is
    for Structure
