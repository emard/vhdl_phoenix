...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25_d125_25 -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -fclkop 125 -fclkop_tol 0.0 -fclkos 125 -fclkos_tol 0.0 -fclkos2 25 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 180 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock 

-- Tue Oct  4 16:14:39 2016
...
architecture Structure of clk_25_d125_25 is
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of clk_25_d125_25 is
    for Structure
