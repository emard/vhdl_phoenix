...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25_250_25 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 250 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 25 -fclkok_tol 0.0 -norst -noclkok2 

-- Mon Oct  3 19:32:38 2016
...
architecture Structure of clk_25_250_25 is
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  10, CLKOP_DIV=>  2, CLKFB_DIV=>  10, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of clk_25_250_25 is
    for Structure
